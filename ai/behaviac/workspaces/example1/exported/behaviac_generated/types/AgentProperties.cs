...
namespace behaviac
{
	...
	public class BehaviorLoaderImplement : BehaviorLoader
	{
		...
		private class CMethod_FirstAgent_m1 : CAgentMethodVoidBase
		{
			CInstanceMember<string> _value;

			public CMethod_FirstAgent_m1()
			{
			}

			public CMethod_FirstAgent_m1(CMethod_FirstAgent_m1 rhs) : base(rhs)
			{
			}

			public override IMethod Clone()
			{
				return new CMethod_FirstAgent_m1(this);
			}
		...
		{
			AgentMeta.TotalSignature = 3533775547;
			...
			meta.RegisterMethod(1759647744, new CMethod_FirstAgent_m1());

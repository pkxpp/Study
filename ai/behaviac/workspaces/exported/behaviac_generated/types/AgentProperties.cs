...
namespace behaviac
{
	...
	public class BehaviorLoaderImplement : BehaviorLoader
	{
		...
		private class CMethod_SecondAgent_m2 : CAgentMethodVoidBase
		{
			CInstanceMember<string> _value;

			public CMethod_SecondAgent_m2()
			{
			}

			public CMethod_SecondAgent_m2(CMethod_SecondAgent_m2 rhs) : base(rhs)
			{
			}

			public override IMethod Clone()
			{
				return new CMethod_SecondAgent_m2(this);
			}

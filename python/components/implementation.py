...
#如果是闭环的图以及没有设置终点，那么就会无限循环死掉
#dijkstra算法讲究的速度，下面这个算法还是做了一个全遍历
...
#study breadth_first_search
g = SquareGrid(30, 15)
g.walls = DIAGRAM1_WALLS

# parents = breadth_first_search(g, (8, 7))
...
#study breadth_first_search end

# 2. dijkstra_search test

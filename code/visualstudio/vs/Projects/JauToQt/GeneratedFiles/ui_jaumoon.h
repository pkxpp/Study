...
**
** Created: Mon Nov 5 10:38:08 2012
...
public:
    ...
    void setupUi(QMainWindow *JauMoon)
    {
        ...
        funcTextEdit = new QTextEdit(instructionGroupBox);
        funcTextEdit->setObjectName(QString::fromUtf8("funcTextEdit"));
        funcTextEdit->setEnabled(true);
        funcTextEdit->setGeometry(QRect(10, 20, 471, 71));

...
{
	ID3DBlob* buffer = 0;
	bool compileResult = CompileD3DShader( "../BlankD3DWindow/ColorInversion/TextureMap.fx", 0,"fx_5_0", &buffer );
	...
	d3dResult = D3DX11CreateShaderResourceViewFromFile( d3dDevice_, "../BlankD3DWindow/ColorInversion/decal.dds", 0, 0, &colorMap_, 0 );
	if( FAILED( d3dResult ) )
	{

...
struct FDynamicStats
{
	...
	*/
	...
	static TStatId CreateStatId( const std::string& StatNameOrDescription )
	{
#if	STATS
	...
	template< typename TStatGroup >
	static TStatId CreateStatIdInt64(const std::string& StatNameOrDescription)
	{
#if	STATS
	...
	template< typename TStatGroup >
	static TStatId CreateStatIdDouble(const std::string& StatNameOrDescription)
	{
#if	STATS

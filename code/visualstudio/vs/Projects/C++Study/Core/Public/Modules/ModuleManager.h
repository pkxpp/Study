...
public:
	 ...
	 */
	void AbandonModule( const /*FName*/std::string& InModuleName );
	 ...
	 */
	void AddModule( const /*FName*/std::string& InModuleName );
	 ...
	 */
	IModuleInterface* GetModule( const /*FName*/std::string& InModuleName );
	 ...
	 */
	bool IsModuleLoaded( const /*FName*/std::string& InModuleName ) const;
	 ...
	 */
	IModuleInterface* LoadModule( const /*FName*/std::string& InModuleName );
	 ...
	 * @see AbandonModule, IsModuleLoaded, LoadModuleChecked, LoadModulePtr, LoadModuleWithFailureReason, UnloadModule
	 */
	IModuleInterface& LoadModuleChecked( const /*FName*/std::string& InModuleName );
	 ...
	 */
	IModuleInterface* LoadModuleWithFailureReason( const /*FName*/std::string& InModuleName, EModuleLoadResult& OutFailureReason );
	 ...
	 * @see QueryModules
	 */
	bool QueryModule( const /*FName*/std::string& InModuleName, FModuleStatus& OutModuleStatus ) const;
	 ...
	 */
	bool UnloadModule( const /*FName*/std::string& InModuleName, bool bIsShutdown = false );
	 ...
	 * @see LoadModuleWithCallback
	 */
	void AbandonModuleWithCallback( const /*FName*/std::string& InModuleName );
	...
	static TModuleInterface& GetModuleChecked( const /*FName*/std::string& ModuleName )
	{
...
private:
	static IModuleInterface* GetModulePtr_Internal(/*FName*/std::string& ModuleName);
...
public:
	...
	/**
	  ...
	  */
	template<typename TModuleInterface>
	static FORCEINLINE TModuleInterface* GetModulePtr( const /*FName*/std::string& ModuleName )
	{
	...
	/**
	  ...
	  */
	template<typename TModuleInterface>
	static TModuleInterface& LoadModuleChecked( const /*FName*/std::string& InModuleName)
	{
	...
	/**
	  ...
	  */
	template<typename TModuleInterface>
	static TModuleInterface* LoadModulePtr( const /*FName*/std::string& InModuleName)
	{
	 ...
	 */
	//void FindModules( const TCHAR* WildcardWithoutExtension, TArray</*FName*/std::string&>& OutModules ) const;
	...
	*/
	std::string GetGameBinariesDirectory() const;
	 ...
	 */
	bool IsModuleUpToDate( const /*FName*/std::string& InModuleName ) const;
#endif
	 ...
	 */
	bool DoesLoadedModuleHaveUObjects( const /*FName*/std::string& ModuleName ) const;
	...
	std::string/*FString*/ GetModuleFilename(/*FName*/std::string& ModuleName) const;
	...
	void SetModuleFilename(/*FName*/std::string& ModuleName, const /*FString*/std::string&& Filename);
...
private:
	...
	public:
		...
		/*FString*/std::string OriginalFilename;

		/** File name of this module (.dll file name) */
		/*FString*/std::string Filename;

mkdir e:\Sword2\游戏运行资源\chib_viet_ch

set srcdir=e:\Sword2\游戏运行资源\chib_viet
set outdir=e:\Sword2\游戏运行资源\chib_viet_ch
...
set version=sword2_viet_2007_09_15_001
set modpath=Sword2\游戏运行资源\越南版
